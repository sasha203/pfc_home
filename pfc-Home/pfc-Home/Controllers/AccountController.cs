    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            try
            {
                ...
                //string name = loginInfo.ExternalIdentity.Claims.ElementAt(1).Value; //Using the key to access the name
                string name = loginInfo.ExternalIdentity.Claims.SingleOrDefault(x => x.Type.Contains("givenname")).Value;
                string surname = loginInfo.ExternalIdentity.Claims.SingleOrDefault(x => x.Type.Contains("surname")).Value;
